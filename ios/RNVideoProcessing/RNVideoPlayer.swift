...
class RNVideoPlayer: RCTView {
	...
	var playerHeight: NSNumber? {
		set(val) {
			if val != nil {
				...
				print("CHANGED HEIGHT \(String(describing: val))")
			}
		}
		get {
			return nil
	...
	var resizeMode: NSString? {
		set {
			...
			self.setNeedsLayout()
			print("CHANGED: resizeMode \(String(describing: newValue))")
		}
		get {
			return nil
		}
	...
	var startTime: NSNumber? {
		set(val) {
			...
			if convertedValue < 0 {
				print("WARNING: startTime is a negative number: \(String(describing: val))")
			...
			print("CHANGED startTime \(String(describing: val))")
		}
		get {
			return nil
		}
	...
	var endTime: NSNumber? {
		set(val) {
			...
			if convertedValue < 0.0 {
				print("WARNING: endTime is a negative number: \(String(describing: val))")
			...
			print("CHANGED endTime \(String(describing: val))")
		}
		get {
			return nil
		}
	...
	var play: NSNumber? {
		set(val) {
			...
			print("CHANGED play \(String(describing: val))")
